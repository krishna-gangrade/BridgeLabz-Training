...
public class OnlineMarketplaceApp {
	...
	public static void main(String[] args) {
		...
		Product book1 = new BookCategory("Java Programming", 49.99);
		Product book2 = new BookCategory("Science Fiction Novel", 19.99);
		Product shirt = new ClothingCategory("Cotton Shirt", 29.99);
		Product phone = new GadgetCategory("Smartphone Pro", 1199.99);
		Product laptop = new GadgetCategory("Gaming Laptop", 1899.99);
