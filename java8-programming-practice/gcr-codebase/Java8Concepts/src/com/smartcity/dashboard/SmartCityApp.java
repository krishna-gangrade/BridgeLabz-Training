...
public class SmartCityApp {
    public static void main(String[] args) {
        ...
        List<Passenger> passengers = Arrays.asList(
                new Passenger("Aryaman", "P001", 45.0, "B101", true),
                new Passenger("Pratham", "P002", 28.0, "M201", false),
                new Passenger("Gautam", "P003", 180.0, "T301", true),
                new Passenger("Prateek", "P004", 42.0, "B101", true),
                new Passenger("Krishna", "P005", 35.0, "B101", false)
        );
